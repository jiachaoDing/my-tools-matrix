        ...
        <nav class="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-3 text-sm text-slate-600 dark:text-slate-300">
                ...
                <a href="${SITE_CONFIG.githubRepo}" 
                   ...
                   class="flex items-center gap-2 rounded-lg bg-slate-900 dark:bg-slate-100 px-3 py-2 text-white dark:text-slate-900 hover:bg-slate-800 dark:hover:bg-slate-200 transition font-semibold shadow-sm"
                   title="Star us on GitHub">
                    ...
                    <span class="hidden sm:inline text-xs">Star</span>
                </a>
            </div>
        </nav>
    `;
